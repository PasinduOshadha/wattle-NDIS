    ...
    const SliderItem = [
        {
            ...
            sliderSubtitle: 'High quality results at prices you can afford',
            sliderTitle: 'Adelaide’s experts in gardening and soft landscaping ',
            sliderbtn: 'request an estimate',
            sliderbtn2: 'About Us',
        },
        {
            id: 2,
            sliderBg: '/assets/img/banner/banner2.jpg',
            sliderSubtitle: 'NDIS Providers',
            sliderTitle: 'On time, on budget and a finish you’ll love !',
            sliderbtn: 'request an estimate',
            sliderbtn2: 'About Us',
        },
        // {
