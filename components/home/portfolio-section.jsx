                            ...
                            <nav>
                                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button className="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1"
                                        type="button" role="tab" aria-controls="nav-1" aria-selected="true">Gardening</button>
                                    <button className="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                                        type="button" role="tab" aria-controls="nav-2" aria-selected="false">Landscaping</button>
                                    <button className="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                                        type="button" role="tab" aria-controls="nav-3" aria-selected="false">Irrigation</button>
                                    <button className="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4"
                                        type="button" role="tab" aria-controls="nav-4" aria-selected="false">Permaculture and Orchard Management </button>
                                        ...
                                        <div className="swiper-container portfolio-active">
                                            {portfolioList &&
                                                <div className="swiper-wrapper">
                                                    ...
                                                    >
                                                        {portfolioList.slice(0, 4).map((item, num) => (
                                                            <SwiperSlide key={num}>
                                                                        ...
                                                                        <div className="portfolio-thumb">
                                                                            {
                                                                                num === 0 ?
                                                                                    ...
                                                                                    <Link href={`/service-details-${num + 1}`}><a>
                                                                                        <div className="beforeAfter">
                                                                                            <img src={item.portfolioImg} />
                                                                                        </div>
                                                                                    </a></Link>
                                                                                            ...
                                                                                            <span className="portfolio-tag">

                                                                                                {
                                                                                                    num === 0 ?
                                                                                                        ...
                                                                                                        <Link href={`/service-details`}><a>{item.portfolioTag}</a></Link>

                                                                                                        :

                                                                                                        <Link href={`/service-details-${num + 1}`}><a>{item.portfolioTag}</a></Link>
                                                                                                }
                                                                                ...
                                                                                <h4 className="portfolio-title">

                                                                                    {
                                                                                        num === 0 ?
                                                                                            ...
                                                                                            <Link href={`/service-details`}><a>{item.portfolioTitle}</a></Link>

                                                                                            :

                                                                                            <Link href={`/service-details-${num + 1}`}><a>{item.portfolioTitle}</a></Link>
                                                                                    }
                                                                            ...
                                                                            <div className="portfolio-btn">
                                                                                {
                                                                                    ...
                                                                                    num === 0 ?
                                                                                        ...
                                                                                        <Link href={`/service-details`}><a className="icon-btn"><i className="fal fa-long-arrow-right"></i></a></Link>
                                                                                        :

                                                                                        <Link href={`/service-details-${num + 1}`}><a className="icon-btn"><i className="fal fa-long-arrow-right"></i></a></Link>
                                                        ...
                                                        {portfolioList.slice(1, 4).map((item, num) => (
                                                            <SwiperSlide key={num}>
                                                                <div className="swiper-slidess">
                                                                    <div className="portfolio-single portfolio-bottom-content">
                                                                        <div className="portfolio-thumb">
                                                                            <Link href={`/service-details-${item.id}`}><a>
                                                                                <div className="beforeAfter">
                                                                                    <img src={item.portfolioImg} />
                                                                                </div>
                                                                            </a></Link>
                                                                        ...
                                                                        <div className="portfolio-content">
                                                                            <div className="portfolio-inner">
                                                                                <div className="portfolio-meta-list">
                                                                                    <div className="portfolio-meta-single">
                                                                                        <div className="portfolio-meta-text">
                                                                                            <span className="portfolio-tag"><Link href={`/service-details-${item.id}`}><a>{item.portfolioTag}</a></Link></span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div className="portfolio-meta-single">
                                                                                        <div className="portfolio-meta-text">
                                                                                ...
                                                                                <h4 className="portfolio-title"><Link href={`/service-details-${item.id}`}><a>{item.portfolioTitle}</a></Link></h4>
                                                                            </div>
                                                                            <div className="portfolio-btn">
                                                                                <Link href={`/service-details-${item.id}`}><a className="icon-btn"><i className="fal fa-long-arrow-right"></i></a></Link>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
