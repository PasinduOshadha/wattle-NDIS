                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/new/940x570px_Service-7.png" alt="" />
                                </div>
                                <h3 className="mb-15">Community Care Nursing</h3>
                                <p className="mb-45">Qualified and skilled Registered nurses provide community nursing support to
                                    participants who require higher levels of care assistance. We offer advanced,
                                    one-on-one medical support and attention, without the hospital.
                                </p>
                                ...
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li>Post-hospital care
                                        </li>
                                        <li>Medication management</li>
                                        <li>Continence management</li>
                                        <li>Vital signs monitoring</li>
                                        <li>Medication set-up and administration</li>
