                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/new/940x570px_Service-11.png" alt="" />
                                </div>
                                <h3 className="mb-15">Household Tasks
                                </h3>
                                <p className="mb-15">We assist our participants in maintaining their household and keeping it clean and
                                    organized. Added support is provided in daily life to enable and empower
                                    participants to live more independently. All household services are personalized to
                                    meet the participant’s specific and unique needs.
                                </p>
