                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/new/940x570px_Service-1.png" alt="" />
                                </div>
                                <h3 className="mb-15">Daily Living Support</h3>
                                <p className="mb-15">
                                    Our daily living support is designed to provide individual assistance tailored to your
                                    unique needs, whether you live independently or in shared accommodation. We
                                    offer support in:

                                </p>

                                {/* <h4 className="mb-25">Our Landscaping Services</h4> */}
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li>Building daily living skills, such as health, nutrition, cooking, and household
                                            routines</li>
                                        <li>Household tasks and chores.</li>
                                        <li>Personal care assistance</li>
                                        <li>Support for individuals with high needs</li>
                                        {/* <li>Stone and Masonry</li>
                                        <li>Decks and Garden Structures</li>
                                        <li>Irrigation and Sprinklers</li>
                                ...
                                {/* <div className="service-sub-image">
                                    <img src="/assets/img/service/bottom photo 1.jpg" alt="" />
                                    <img src="/assets/img/service/bottom photo 2.jpg" alt="" />
                                </div> */}
