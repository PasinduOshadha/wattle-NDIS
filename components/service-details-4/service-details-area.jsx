                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/new/940x570px_Service-6.png" alt="" />
                                </div>
                                <h3 className="mb-15">Support Coordination</h3>
                                <p className="mb-45">Our Support Coordinators help you understand, implement, and use your plan
                                    effectively. They ensure a mix of support is used to enhance your capacity to
                                    maintain relationships, manage service tasks, live more independently, and
                                    participate in your community. </p>
                                ...
                                {/* <div className="sidebar-service-list2">
                                    <ul>
                                        ...
                                        <li>Testing and improving soil</li>
                                        <li>Fertilisation and soil conservation</li>
                                        <li>Integrated pest management</li>
                                        <li>Consultation for orchard management</li>
                                        <li>Implementing sustainable solutions for the backyard while less impact on the natural ecosystems</li>
                                        <li>Installation of chicken coups and raised garden beds with recycled material</li>
