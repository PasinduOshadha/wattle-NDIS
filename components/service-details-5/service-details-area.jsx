                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/940x570px_Service-5_Social-_-Community.png" alt="" />
                                    {/* <img src="/assets/img/service/new/940x570px_Service-5.png" alt="" /> */}
                                </div>
                                <h3 className="mb-15">Social & Community Participation</h3>
                                <p className="mb-45">Our staff facilitates social connections and community engagement, both in group
                                    and individual settings. We provide services such as mentoring, guest speaking,
                                    and individual social support. These services encompass: </p>

                                {/* <h4 className="mb-25">Our horticulture and permaculture Services</h4> */}
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li>Assisting you in accessing community and recreational activities.
                                        </li>
                                        <li>Offering group and center-based activities.</li>
                                        <li>Helping you develop life skills, either individually or in group sessions.</li>
