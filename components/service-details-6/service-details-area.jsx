                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/940x570px_Service-6_24-Hour-High-Intensity-Nursing.png" alt="" />
                                    {/* <img src="/assets/img/service/new/940x570px_Service-3.png" alt="" /> */}
                                </div>
                                <h3 className="mb-15">24 Hour High Intensity Nursing and Personal Care</h3>
                                <p className="mb-15">With an extensive background in nursing, our registered nurses are able to provide
                                    support with High Intensity Daily Personal Activities round the clock.
                                </p>
                                <p className="mb-15">Whether our participants are diagnosed with a serious, chronic or life-threatening
                                    illness or a challenging health condition, we are committed to improve the quality of
                                    life of participants and help them manage their disease or illness
                                </p>
                                <p className="mb-45">High intensity personal care with complex needs includes the following care
                                    services and more.
                                </p>
                                ...
                                <div className="sidebar-service-list2">
                                    <ul>
                                        ...
                                        <li>Administration of injections</li>
                                        <li>Catheter care</li>
                                        <li>Enteral gastric feeding</li>
                                        <li>Complex wound care</li>
                                        <li>Medication Administration</li>
                                        <li>Administration of injections</li>
                                        <li>PEG Feeding</li>
                                        <li>Blood Pressure Care</li>
                                        <li>Wound drain management/removal (open/closed/suction)</li>
                                        <li>Medication management including IV antibiotics administration</li>
