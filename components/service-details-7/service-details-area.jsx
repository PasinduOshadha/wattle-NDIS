                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/new/940x570px_Service-7_Assistance-With-Life-Stage-Transition.png" alt="" />
                                </div>
                                <h3 className="mb-15">Assistance with Life Stage Transition</h3>
                                <p className="mb-15">Transitioning into a new life stage can be a challenging or overwhelming
                                    experience. </p>
                                <p className="mb-15">Our compassionate, empathetic and experienced caregivers ensure that the
                                    transition is effortless and smooth. Where change is inevitable, we help you get
                                    through these changes and transitions in a well-prepared manner, and assist you to
                                    understand how to respond. </p>
                                <p className="mb-45">We will be there to support you through your transitioning into a new stage of your
                                    life. We work towards meeting the diverse requirements of our participants</p>
                                ...
                                ●
                                ●
                                ● Independent living skills and self-care ability to strengthen existing
                                capacities
                                ●
                                ●
                                ●
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li> Support coordination and connection
                                        </li>
                                        <li>Assistance with decision-making</li>
                                        <li> Assistance with tenancy and accommodation</li>
                                        <li>Individual skill development, peer support, planning and mentoring</li>
                                        <li>Financial management and daily budgeting
                                        </li>
                                        <li>Crisis management and conflict resolution</li>
                                        <li>Establishing new connections in the community</li>
                                        <li>Independent living skills and self-care ability to strengthen existing
                                            capacities</li>
                                        <li>Possessing the ability to take care of oneself and manage one’s own life
                                            independently</li>
                                        <li>Methods for Dealing with Emergencies and Conflicts</li>
                                        <li>The provision of assistance in linking to other helpful local services and
                                            initiatives</li>
                                    </ul>
                                </div>
