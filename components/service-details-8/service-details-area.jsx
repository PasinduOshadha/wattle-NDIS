                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/940x570px_Service-8_Assistance-With-Travel.png" alt="" />
                                    {/* <img src="/assets/img/service/new/940x570px_Service-4.png" alt="" /> */}
                                </div>
                                <h3 className="mb-15">Assistance with Travel/Transport Arrangements</h3>
                                <p className="mb-15">We enable participants to build their ability to independently travel using our travel
                                    and transport support services</p>
                                <p className="mb-15">We assist participants get to appointments, shopping centers, run errands or travel
                                    to any other socializing activity they may need to attend.</p>
                                <p className="mb-45">We assist participants with their travel needs through public transport or their own
                                    vehicle</p>

                                {/* <h4 className="mb-25">Our horticulture and permaculture Services</h4> */}
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li>Pick-up and drop-off by support drivers.</li>
                                        <li>Personal transport training to use public transport</li>
                                        <li>Assisting participants to travel to community activities, medical
                                            appointments, or place of education/employment.</li>
                                        <li>Access to taxis, rideshares, community transport, registered transport
                                            providers and other appropriate transport methods.
                                        </li>
