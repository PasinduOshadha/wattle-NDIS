                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="service-details-main mb-60">
                                <div className="service-image">
                                    <img src="/assets/img/service/940x570px_Service-1_Accommodation.png" alt="" />
                                    {/* <img src="/assets/img/service/new/940x570px_Service-8.png" alt="" /> */}
                                </div>
                                <h3 className="mb-15">Accommodation Services</h3>
                                <p className="mb-45">Wattle Healthcare provides supported NDIS accommodation services supported independent living (SIL) for people with disabilities. We also assist
                                    in finding suitable accommodations and managing tenancy requirements. These
                                    services are covered by your NDIS plan if included.</p>
                                ...
                                {/* <h4 className="mb-25">Our Maintenance Services</h4>
                                <div className="sidebar-service-list2">
                                    <ul>
                                        <li>Annual Flower Beds</li>
                                        <li>Hedging, Pruning and Trimming</li>
                                        <li>Planting</li>
                                        <li>Soil Amending and Topping</li>
                                        <li>Container Gardens for Balconies</li>
                                        <li>Lawn care</li>
                                        <li>Preparing Yards for Spring</li>
                                        <li>Weeding</li>
                                        <li>Mulching</li>
                                ...
                                <div className="how-works-wrapper">
                                    <div className="working-steps">
                                        ...
                                        <div className="work-step">
                                            ...
                                            <h4>Free on-site visit & quotation</h4>
                                        ...
                                        <div className="work-step">
                                            <div className="work-step-icon">
                                                <img src="/assets/img/icon/work-icon4.png" alt="" />
                                            </div>
                                            <h4>Maintenance</h4>
